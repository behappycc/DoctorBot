...
Output:
data/training_sentence.txt
data/training_slot.txt
**`mkdir data` directory first

Training data format:
Sentence, e.g. "我 想要 預約 耳鼻喉科" in training_sentence.txt
Slot, e.g. "o o o b-division" in training_slot.txt
"""
...
def main():
    ...
    pattern_list = [
        ...
        [['我', ''], ['想', '要', '想要'], ['看', '掛', '掛號', '預約'], [' &5']]
    ]

    st_wf = open("data/training_sentence.txt", "w")
    sl_wf = open("data/training_slot.txt", "w")
