...
tf.app.flags.DEFINE_integer("word_embedding_size", 128, "Size of the word embedding") # 299
tf.app.flags.DEFINE_integer("num_layers", 1, "Number of layers in the model.")
tf.app.flags.DEFINE_integer("in_vocab_size", 10000, "max vocab Size.")  # 10696
...
tf.app.flags.DEFINE_integer("steps_per_checkpoint", 5,  # 300
                            "How many training steps to do per checkpoint.")
tf.app.flags.DEFINE_integer("max_training_steps", 15,  # 10000
                            "Max training steps.")
