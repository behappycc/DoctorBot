...
# inform
    json_list = [
        ["inform(slot='intent')", "請問今天想要找我做什麼呢", "請問您有什麼需求呢"],
        ["inform(slot='disease')", "請告訴我您有什麼毛病嗎", "請告訴我疾病的名稱"],
        ["inform(slot='division')", "要掛哪一科呢", "請問您要掛哪一科的門診呢"],
        ["inform(slot='doctor')", "指定的醫生名字是", "告訴我醫生的名字才能為您掛號喔"],
        ["inform(slot='time')", "您方便的日期是", "那你想在哪一天的什麼時間看診呢"],
        ["inform(slot='intent')", "嗨嗨你想使用什麼服務呢", "需要哪一類的幫助呢"],
        ["inform(slot='disease')", "跟我說疾病名稱或症狀，我就能幫你查到相關資料唷", "身體有哪邊不舒服嗎"],
        ["inform(slot='division')", "請問您想掛號的科是", "請問您要掛哪一科的門診呢"],
        ["inform(slot='doctor')", "告訴我醫生的名字就可以掛號囉", "請問您想要看哪個醫生？名字是"],
        ["inform(slot='time')", "請您選個黃道吉日良辰吉時吧", "接下來請告訴我您想要的日期"],
        ["inform(slot='intent')", "今天打算從什麼服務做起呢", " 請問您需要什麼醫療服務呢"],
        ["inform(slot='disease')", "你覺得自己生了什麼病呢", " 我可以告訴你疾病對應的症狀喔，你想知道什麼呢"],
        ["inform(slot='division')", "請問您現在要查的應該是什麼科的呢", "請告訴我科別，才能為您做接下來的查詢及掛號喔"],
        ["inform(slot='doctor')", "醫生的大名是什麼", "請問您找尋的醫生是那一位呢"],
        ["inform(slot='time')", "請問您想在幾月幾號看診呢", "請問你打算什麼時候去看診呢"]
    ]
